...
public class ListViewActivityFragment extends Fragment implements ListViewRekapOrderAdapter.OnItemClickListener,
        SearchView.OnQueryTextListener {
    private static final String LOG_TAG = ListViewActivityFragment.class.getSimpleName();
    ...
    private void getOrderList(final SwipeRefreshLayout swipe) {
        ...
        call3.enqueue(new Callback<Order>() {
            ...
            public void onResponse(Call<Order> call, Response<Order> response) {
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        ...
                        listViewRekapOrderAdapter.setOnItemClickListener(ListViewActivityFragment.this);
            ...
            public void onFailure(Call<Order> call, Throwable t) {
                ...
                Toast.makeText(getActivity().getApplicationContext(), "Terjadi gangguan koneksi", Toast.LENGTH_LONG).show();
                call.cancel();
...
*/
    ...
    public void deleteDbUnused(){
        ...
        ArrayList<OrderItem> orderDelete   = (ArrayList)SQLite.select().from(OrderItem.class)
                .where(OrderItem_Table.status.in("1","2","0"))
                .queryList();
    ...
    private void printIT(int i) {
        ...
        if (printerName.equals("sprt")) {
            ...
            printBT(SelectedBDAddress, GetLogo(getActivity().getApplicationContext(), sbuff.toString()));
        }

...
public class Report3Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //myWebView.loadUrl(AppUtil.BASE_URL + "report2?u="+ Utility.getSetting(getActivity(), Utility.MD5("US"), ""));
        myWebView.loadUrl(AppUtil.BASE_HOST + "mapkamm/imob/1?coll="+ Utility.getSetting(getActivity(), Utility.MD5("US"), ""));

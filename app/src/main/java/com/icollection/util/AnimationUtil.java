...
public class AnimationUtil {
    ...
    public static void animateFadeIn(View view, int position) {
        boolean isFirstItem = position == -1;
        position = position + 1;
        view.setAlpha(0.f);
        ...
        animatorAlpha.setStartDelay(isFirstItem ? DURATION_IN_FADE_ID / 2 : (position * DURATION_IN_FADE_ID / 3));
    ...
    public static void animateBottomUp(View view, int position) {
        boolean isFirstItem = position == -1;
        position = position + 1;
        view.setTranslationY(isFirstItem ? 800 : 500);
        view.setAlpha(0.f);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(view, "translationY", isFirstItem ? 800 : 500, 0);
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.f);
        animatorTranslateY.setStartDelay(isFirstItem ? 0 : (position * DURATION_IN_BOTTOM_UP));
        animatorTranslateY.setDuration((isFirstItem ? 3 : 1) * DURATION_IN_BOTTOM_UP);
    ...
    public static void animateLeftRight(View view, int position) {
        ...
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.f);
        ObjectAnimator.ofFloat(view, "alpha", 0.f).start();
        animatorTranslateY.setStartDelay(isFirstItem ? DURATION_IN_LEFT_RIGHT : (position * DURATION_IN_LEFT_RIGHT));
        animatorTranslateY.setDuration((isFirstItem ? 2 : 1) * DURATION_IN_LEFT_RIGHT);
        animatorSet.playTogether(animatorTranslateY, animatorAlpha);
        animatorSet.start();
    }
    ...
    public static void animateRightLeft(View view, int position) {
        ...
        ObjectAnimator animatorAlpha = ObjectAnimator.ofFloat(view, "alpha", 1.f);
        ObjectAnimator.ofFloat(view, "alpha", 0.f).start();
        animatorTranslateY.setStartDelay(isFirstItem ? DURATION_IN_RIGHT_LEFT : (position * DURATION_IN_RIGHT_LEFT));
        animatorTranslateY.setDuration((isFirstItem ? 2 : 1) * DURATION_IN_RIGHT_LEFT);
        animatorSet.playTogether(animatorTranslateY, animatorAlpha);
        animatorSet.start();
    }
}

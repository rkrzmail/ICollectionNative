...
//		cal.set(mYear, mMonth, mDay-1);
	...
	public static String getExternalPath() {
		...
		return new File(getAppContext().getExternalFilesDir(null), "").getAbsolutePath()  ;
	}
	...
	public static String getCacheDir(String fname) {
		...
		return new File(getAppContext().getExternalFilesDir(null), fname).getAbsolutePath()  ;
	}

	public static File getFileCamera() {
		//File photo = new File(Environment.getExternalStorageDirectory(), "image");
		return new File(getAppContext().getExternalFilesDir(null), "image");
	}
